...
class choice_chenge : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.choice_chenge)
        layout_1 = findViewById(R.id.gimchizzigae)
        layout_2 = findViewById(R.id.woodong)
        layout_3 = findViewById(R.id.yukwhue)
        ...
        layout_2?.setOnClickListener(View.OnClickListener { v ->
            val builder = AlertDialog.Builder(v.context)
            val string_deungsim = "ex)알레르기 정보 : 돼지고기, 밀, 대두 \n600kccal\n4000원"
            builder.setTitle("우동").setMessage(string_deungsim)
            builder.setPositiveButton("장바구니 담기") { dialog, id ->
                val mainData =
                    MainData(R.drawable.woodong, "우동", "4000원", R.drawable.item_delete_image)
                // 장바구니에 추가하는 부분
                addToCart(mainData)
                Toast.makeText(applicationContext, "장바구니에 담김", Toast.LENGTH_SHORT).show()
            }
        ...
        layout_3?.setOnClickListener(View.OnClickListener { v ->
            ...
            builder.setTitle("육회비빔밥").setMessage(string_deungsim)
            builder.setPositiveButton("장바구니 담기") { dialog, id ->
                val mainData =
                    MainData(R.drawable.yukwhue, "육회비빔밥", "6000원", R.drawable.item_delete_image)
                // 장바구니에 추가하는 부분
                addToCart(mainData)
                Toast.makeText(applicationContext, "장바구니에 담김", Toast.LENGTH_SHORT).show()
            }
        ...
        item_cart?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@choice_chenge, Item_Cart2::class.java)
